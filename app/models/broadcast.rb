...
class Broadcast < ActiveRecord::Base
    ...
    def as_json(options={})
      json = {:id => id, :title => title, :start => start, :end => self.end, :duration => duration, :description => synopsis, :watchers => intentions_count.to_i, :channel => {:name => channel.name}, :link => link}
